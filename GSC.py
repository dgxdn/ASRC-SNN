...
"""
from https://github.com/ZhangShimin1/TC-LIF/blob/main/GSC-v2/data.py
"""

def download(raw_data_dir):
    url = 'http://download.tensorflow.org/data/speech_commands_v0.01.tar.gz'
    save_dir = raw_data_dir
    tarname = save_dir + '/google_speech_commands_v1.tar.gz'
...
def google12_v2(dataroot):
    version = 'v2'
    if version == 'v1':
        data_dir = dataroot+ '/google_speech_command_1'
    elif version == 'v2':
        data_dir = dataroot + '/google_speech_command_2'
